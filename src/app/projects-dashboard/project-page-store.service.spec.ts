...
describe('ProjectPageStoreService', () => {
  ...
  describe('Add async', () => {
    ...
    it('should set loading state to loading', () => {
      service.addProjectAsync({ id: '1', name: 'a', projectType: ProjectRole.OWNER });
    ...
    it(
      ...
      waitForAsync(() => {
        const addSpy = spyOn(projectService, 'add').and.returnValue(
          of({ id: '1', name: 'a', projectType: ProjectRole.OWNER })
        );
  ...
  describe('Update async', () => {
      ...
      waitForAsync(() => {
        service.patchState({
          projects: [
            ...
            { id: '2', name: 'a', projectType: ProjectRole.OWNER },
    ...
    it('should set loading state to loading', () => {
      service.updateProjectAsync({ id: '1', name: 'a', projectType: ProjectRole.OWNER });
    ...
    it(
      ...
      waitForAsync(() => {
        const updateSpy = spyOn(projectService, 'update').and.returnValue(
          of({ id: '2', name: 'updated', projectType: ProjectRole.OWNER })
        );

        const patchSpy = spyOn(service, 'patchState').and.callThrough();

        service.updateProjectAsync({ id: '2', name: 'updated', projectType: ProjectRole.OWNER });
        service.projects$.subscribe(x => {
    ...
    beforeEach(
      waitForAsync(() => {
        service.patchState({
          projects: [
            { id: '1', name: 'a', projectType: ProjectRole.OWNER },
            { id: '2', name: 'b', projectType: ProjectRole.OWNER },
            { id: '3', name: 'c', projectType: ProjectRole.OWNER },
          ],
        });
      })
    );
