...
import { CreateUserProjectDto } from 'src/app/projects-dashboard/create-user-project.dto';
import { UpdateUserProjectDto } from 'src/app/projects-dashboard/update-user-project.dto';
...
export class UserService {
  ...
  createProject(project: CreateUserProjectDto): Observable<ProjectListItem> {
    return this.http.post<ProjectListItem>(`${this.baseUrl}/${this.auth.sub}/projects`, project);
  }

  updateProject(id: string, project: UpdateUserProjectDto): Observable<ProjectListItem> {
    return this.http.patch<ProjectListItem>(`${this.baseUrl}/${this.auth.sub}/projects/${id}`, project);
  }
